         ...
         <div class="stepwizard">
             <div class="stepwizard-row setup-panel">
               <div class="stepwizard-step col-xs-3"> 
                 ...
                 <div class="stepwizard-step col-xs-3"> 
                     <a href="{{url('/ice')}}" type="button" class="btn btn-success btn-circle mr-3" disabled="disabled"> 
                        <h4>2</h4>
                     </a>
                     <h4 class="mr-3"><small>Iced Beverage</small></h4>
                 </div>
                 <div class="stepwizard-step col-xs-3"> 
                     <a href="{{url('/hot')}}" type="button" class="btn btn-default btn-circle ml-3" disabled="disabled">
                        <h4>3</h4>
                     </a>
